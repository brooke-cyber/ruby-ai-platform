            ...
            <div className="space-y-8">
              ...
              <div className="border border-neutral-200 p-8">
                ...
                <div className="space-y-6">
                  {[
                    { step: "1", title: "Draft Review", desc: "A licensed Canadian lawyer reviews your Expert Draft for legal accuracy, enforceability, and compliance.", time: "Within 24 hours" },
                ...
                <div className="px-5 sm:px-8 md:px-12 py-8 bg-white max-h-[60vh] overflow-y-auto" style={{ fontFamily: "'Georgia', 'Times New Roman', serif", fontSize: '14px', lineHeight: '1.65', color: '#1a1a1a' }}>
                  ...
                  <div className="mt-10 pt-6 border-t border-neutral-300">
                    <p style={{ fontFamily: "'Inter', 'Helvetica Neue', sans-serif", fontSize: '10.5px', lineHeight: '1.6', color: '#78716c', letterSpacing: '0.01em' }}>
                      This document was generated by Ruby Law&apos;s Expert Draft engine and has not been reviewed by a licensed lawyer. It does not constitute legal advice, a legal opinion, or a lawyer-client relationship. For binding legal advice, consult a licensed lawyer before signing.
                    </p>
                  </div>
                </div>
              </div>

              {/* LSO Disclaimer — Expert Draft (non-counsel-review) */}
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-neutral-200">
        <div className="max-w-5xl mx-auto px-8 py-5 flex items-center justify-between">
          <span className="font-serif text-[15px] text-neutral-900 tracking-tight">Ruby Law</span>
          <span className="text-[12px] text-neutral-400 uppercase tracking-[0.15em]">Generated Agreement</span>
        </div>
      </header>
      ...
      <div className="max-w-3xl mx-auto px-8 py-14">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4">
          <div>
            <h1 className="font-serif text-2xl sm:text-3xl text-neutral-900 tracking-tight">Your Agreement Draft</h1>
        ...
        <div className="border border-neutral-200">
          ...
          {/* Full agreement — clean legal typography in scrollable container */}
