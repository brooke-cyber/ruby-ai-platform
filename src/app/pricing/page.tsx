...
export default function PricingPage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: 'Yes. After your base contract is generated, you can request modifications through our Legal Drafting Engine. Each modification is priced by complexity. Volume discounts apply automatically.',
    },
    {
      ...
      <section className="px-4 py-16 md:py-24 bg-[#faf9f7]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-lg mx-auto">Every agreement is available as Expert Draft or with Lawyer Review.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-8">
              ...
              <div className="border-t border-gray-100 pt-5">
                ...
                <p className="text-3xl font-bold text-gray-900">$149 <span className="text-sm font-normal text-gray-400">CAD</span></p>
              </div>
            </div>

            {/* Expert Draft + Lawyer Review */}
            <div className="rounded-xl border-2 border-[#be123c]/20 bg-white p-8 relative">
              <div className="absolute -top-3 left-6">
                <span className="inline-block bg-[#be123c] text-white text-[13px] font-semibold px-3 py-1 rounded-full uppercase tracking-wider">
                  Recommended
                </span>
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-1">Expert Draft + Lawyer Review</h3>
              ...
              <div className="border-t border-gray-100 pt-5">
                <p className="text-[13px] uppercase tracking-wider text-gray-400 mb-1">Starting at</p>
                <p className="text-3xl font-bold text-[#be123c]">$349 <span className="text-sm font-normal text-gray-400">CAD</span></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500">Every agreement, one clear price. Click a category to see pricing.</p>
          </div>
          ...
          {/* Pricing table for selected category */}
          {openCategory && (
            <div className="overflow-hidden rounded-xl border border-gray-200 bg-white">
              <table className="w-full">
                ...
                <tbody>
                  {AGREEMENTS.filter((a) => a.category === openCategory || a.crossListedIn?.includes(openCategory!)).map((agreement, idx) => (
                    <tr
                      key={agreement.id}
          ...
          <div className="mt-6 text-center">
            <Link href="/documents" className="text-sm font-medium text-[#be123c] hover:underline">
              Browse all 27 agreements &rarr;
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 py-16 md:py-24 bg-[#faf9f7]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 max-w-lg mx-auto">Need changes beyond the wizard? Request modifications through our Legal Drafting Engine, priced by complexity.</p>
          </div>

          {/* 3 complexity tiers — compact */}
      ...
      <section className="px-4 py-16 md:py-24">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 max-w-lg mx-auto">Every bundle includes lawyer review for all documents.</p>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {bundles.map((bundle) => (
              <div
                key={bundle.name}
                className={`relative rounded-xl border bg-white p-6 transition-all hover:shadow-md ${
                  bundle.popular ? 'border-gray-300 shadow-md' : 'border-gray-200 shadow-sm'
                }`}
              >
                {bundle.popular && (
                  <div className="absolute -top-3 left-5">
                    <span className="inline-block bg-[#be123c] text-white text-[10px] font-semibold px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                      Most Popular
                    </span>
                  </div>
                )}
                ...
                <div className="flex items-baseline justify-between mb-3">
                  ...
                  <span className="text-lg font-bold text-[#be123c]">${bundle.price.toLocaleString()}</span>
                </div>
                ...
                <ul className="space-y-1.5 mb-5">
                  {bundle.includes.map((item) => (
                    <li key={item} className="flex items-start gap-2">
                      <svg className="h-3.5 w-3.5 text-[#be123c] mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                      </svg>
                ...
                <button
                  ...
                  className={`block w-full text-center rounded-lg px-5 py-2.5 font-semibold text-sm transition-all ${
      ...
      <section className="px-4 py-16 md:py-24 bg-[#faf9f7]">
        <div className="max-w-3xl mx-auto">
          <div className="mb-8 text-center">
            <h2 className="font-serif text-3xl font-bold text-gray-900">Common questions</h2>
          </div>
            ...
            {faqItems.map((item, idx) => (
              ...
              >
                ...
                >
                  ...
                  <svg
                    className={`w-4 h-4 text-[#be123c] flex-shrink-0 transition-transform duration-300 ${
          ...
          <div className="mt-6 text-center">
            <Link href="/faq" className="text-sm font-medium text-[#be123c] hover:underline">
              View all FAQs &rarr;
            </Link>
          </div>
        </div>
